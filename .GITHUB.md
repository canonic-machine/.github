...
**Version:** 0.2.0
**Date:** 2026-01-22
**Freeze:** `appstore-v0.2.0` (pending)

inherits: /canonic/

**APPSTORE** is the conceptual name. `/.github/` is the scope path.
This scope IS the **CANONBASE** - the aggregate view of the entire multi-repo stack.
...
Valid(APPSTORE) =
  ...
  ∧ COVERAGE aggregates ALL scopes in CANONBASE
  ∧ ROADMAP aggregates ALL scopes in CANONBASE
```
